    ...
    async function MostraRepos() {
        ...
        repos.forEach(element => {
            ...
            divRepos.innerHTML = `
                    ...
                    <a href="/htmls/repo.html?id=${element.id}" class="text-decoration-none text-dark stretched-link
"></a>
            `;
    ...
    async function MostrarAmigos() {
        ...
        conteudo.forEach((item) => {
            ...
            <div class="card w-100 h-100">
              ...
              <div class="card-body">
                <h3><a class="fb" target = "_blank" href="${item.git}">${item.nome}</a></h3>
              </div>
            </div>
            `;
